...
Она запускает статические проверки, 154 Python-теста и оба набора браузерных
сценариев. Если браузерный слой пока не установлен, можно проверить ядро и
артефакты без UI: `.\verify.ps1 -SkipUi`.
